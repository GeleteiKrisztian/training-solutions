...
public class WorkHoursCalculator {
    ...
    public long calculateHours(int year, Month month, int day, int hour) {
        ZonedDateTime zonedDateTime = ZonedDateTime.of(LocalDateTime.of(year, month, day, hour, 0), startDateTime.getZone());
        return Duration.between(startDateTime, zonedDateTime).toHours();
    }
